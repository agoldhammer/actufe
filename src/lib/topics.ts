export const helpitems = [
	...
	},
	{
		id: 'help5',
		topic: 'Keyword Query',
		description: `To search for one or more keywords occuring in summary texts, press the 'Query' key, then type the desired search terms
    in the text box. Finally, press 'Enter' or click/touch the 'Submit' button`
	},
	{
		id: 'help6',
		topic: 'Quirks',
